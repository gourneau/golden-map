...
export const PULSARS = [
  {
    ...
    distNote: 'Supernova-remnant association gives 0.7 kpc; the YMW16 electron-density model says 5.5 kpc — the widest distance ambiguity on the map.',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: 'VLBI parallax: 0.43 kpc — about 2.7× farther than the engraved line length claims.',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: 'ATNF best estimate 2.0 kpc; DM models range 7.4–9.4 kpc. Highly model-dependent.',
    confidence: 'probable',
    note: 'The map’s one honest engraving error: its period was known to only 3 significant digits in 1971, yet was engraved to ~30 binary digits of spurious precision. It is also within 0.2% of line 14’s period — only the line’s direction tells them apart.',
  ...
  },
  {
    ...
    distNote: 'VLBI parallax: 287 pc (Dodson et al. 2003). The engraved line is ~4.5× too long.',
    confidence: 'secure',
    note: 'The Vela pulsar, embedded in a supernova remnant ~11,000 years old. Young, fast-slowing, and prone to sudden glitches — one of the map’s two built-in clocks.',
  },
  {
    ...
    distNote: 'VLBI parallax: 261 pc (Brisken et al. 2002). One of the nearest pulsars known.',
    confidence: 'secure',
    note: 'High above the galactic plane — one of the three lines whose engraved angle is off, by ~10.6°.',
    flaw: 'angle',
    angleErrorDeg: 10.6,
  },
  {
    ...
    distNote: 'VLBI parallax: 0.50 kpc (Deller et al. 2019).',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: '2.0 ± 0.5 kpc via the Crab Nebula, remnant of the supernova of A.D. 1054 — one of the best-anchored distances on the map.',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: 'DM-only distance, 1.2 kpc (older models said ~2.3).',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: 'Parallax-based, 1.0–1.7 kpc range; ATNF best estimate 1.68 kpc.',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: 'DM-only distance (no parallax): 2.38 kpc, model-dependent.',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: 'VLBI parallax: 0.98 kpc (Brisken et al. 2002); the DM model agrees.',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: 'VLBI parallax (Ding et al. 2023): 3.7 kpc. Later electron-density models had pushed its assumed distance to ~7.9 kpc — more than double the engraved value — before the parallax settled it back near the original guess.',
    confidence: 'secure',
  ...
  },
  {
    ...
    distNote: 'VLBI parallax: 0.31 kpc — nearly 4× the engraved distance.',
    confidence: 'secure',
    note: 'Drawn as the nearest pulsar on the map, at a distance we now know was almost four times too small.',
  },
  {
    ...
    distNote: 'ATNF lists 4.0 kpc (HI absorption); YMW16 says 1.33 kpc. Either way, far beyond the engraved 0.32 kpc — the largest distance error on the map.',
    confidence: 'secure',
